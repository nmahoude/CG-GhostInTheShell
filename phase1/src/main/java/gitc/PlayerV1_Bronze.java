...
//            if (oppLink != null && oppLink.toFactory.isMe() && oppLink.toFactory.units > 0) {
//              Factory myFactory = oppLink.toFactory;
//              Link myLink = myFactory.getLinkToFactory(oppFactory.id);
//              if (myFactory.units + myLink.cyborgsInTransit > oppFactory.units + oppFactory.production*oppLink.distance) {
//                int neededCyborgs = oppFactory.units + oppFactory.production*oppLink.distance - oppLink.cyborgsInTransit;
...
//            if (link != null && link.toFactory.isMe() && link.toFactory.units > 0) {
...
//              int neededCyborgs = neutralFactory.units + 1;
